import { BiLogoAws, BiLogoCss3, BiLogoHtml5, BiLogoJavascript, BiLogoMongodb, BiLogoNodejs, BiLogoReact, BiLogoTailwindCss } from "react-icons/bi"
...
const Tech = () => {
  ...
  return <div id="tech" className="flex min-h-[70vh] w-full flex-col items-center justify-center gap-16 md:gap-32">
    ...
    <div className="flex flex-wrap items-center justify-center gap-10 p-5">
      ...
      whileInView="visible"
      transition={{duration:0.5}}>
        <BiLogoAws className="cursor-pointer text-[80px] text-orange-400 transition-all duration-300 hover:-translate-y-5 sm:text-[100px]md:text-[120px]" />
      </motion.div>
      <motion.div 
      variants={variants}
      initial="hidden"
